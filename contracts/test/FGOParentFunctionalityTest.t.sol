...
contract FGOParentFunctionalityTest is Test {
    ...
    function setUp() public {
        ...
        designers = new FGODesigners(address(accessControl));
    ...
    function testParentCreation() public {
        ...
        vm.stopPrank();
        vm.startPrank(supplier1);
        childContract1.approveParentRequest(child1Id, reservedId, address(parentContract));
        childContract2.approveParentRequest(child2Id, reservedId, address(parentContract));
        vm.stopPrank();
        vm.startPrank(designer1);
        
        uint256 parentId = parentContract.createParent(reservedId, params);
        assertEq(parentId, reservedId);
        
        assertEq(parentContract.ownerOf(parentId), designer1);
        
        FGOLibrary.ParentMetadata memory metadata = parentContract.getDesignTemplate(parentId);
        ...
        FGOLibrary.ChildMetadata memory child1Metadata = childContract1.getChildMetadata(child1Id);
        assertEq(child1Metadata.usageCount, 1);
        
        FGOLibrary.ChildMetadata memory child2Metadata = childContract2.getChildMetadata(child2Id);
    ...
    function testParentCreationWithoutApproval() public {
        ...
        parentContract.createParent(reservedId, params);
    ...
    function testParentUpdate() public {
        ...
        FGOLibrary.UpdateParentParams memory updateParams = FGOLibrary.UpdateParentParams({
            designId: parentId,
            digitalPrice: 600,
            physicalPrice: 900,
    ...
    function testParentDisableEnable() public {
        ...
        FGOLibrary.ParentMetadata memory metadata = parentContract.getDesignTemplate(parentId);
        assertTrue(metadata.status == FGOLibrary.ActiveStatus.DISABLED);
    ...
    function testParentDeletion() public {
        ...
        FGOLibrary.ChildMetadata memory child1BeforeDelete = childContract1.getChildMetadata(child1Id);
        FGOLibrary.ChildMetadata memory child2BeforeDelete = childContract2.getChildMetadata(child2Id);
        ...
        FGOLibrary.ChildMetadata memory child1AfterDelete = childContract1.getChildMetadata(child1Id);
        FGOLibrary.ChildMetadata memory child2AfterDelete = childContract2.getChildMetadata(child2Id);
    ...
    function testMarketApprovalWorkflow() public {
        ...
        FGOLibrary.MarketApprovalRequest memory request = parentContract.getMarketRequest(parentId, market2);
    ...
    function testBatchParentReservation() public {
        ...
        FGOLibrary.ChildReference[] memory childRefs1 = new FGOLibrary.ChildReference[](1);
        ...
        FGOLibrary.ChildReference[] memory childRefs2 = new FGOLibrary.ChildReference[](1);
        ...
        steps[0] = FGOLibrary.FulfillmentStep({
            ...
            primaryPerformer: fulfiller1,
            shipToNext: address(0),
            instructions: "Batch fulfillment",
            subPerformers: new FGOLibrary.SubPerformer[](0),
            requiredChildIds: new uint256[](0)
        });
        ...
        FGOLibrary.CreateParentParams[] memory batchParams = new FGOLibrary.CreateParentParams[](2);
        ...
        uint256[] memory reservedIds = parentContract.reserveParentBatch(batchParams);
    ...
    function testBatchParentCreation() public {
        ...
        vm.stopPrank();
        vm.startPrank(supplier1);
        childContract1.approveParentRequest(child1Id, reservedIds[0], address(parentContract));
        childContract2.approveParentRequest(child2Id, reservedIds[1], address(parentContract));
        vm.stopPrank();
        vm.startPrank(designer1);
        
        uint256[] memory parentIds = parentContract.createParentBatch(reservedIds, batchParams);
        assertEq(parentIds.length, 2);
        assertEq(parentIds[0], 1);
        assertEq(parentIds[1], 2);
        
        assertEq(parentContract.ownerOf(parentIds[0]), designer1);
        assertEq(parentContract.ownerOf(parentIds[1]), designer1);
        
        FGOLibrary.ParentMetadata memory metadata1 = parentContract.getDesignTemplate(parentIds[0]);
        assertEq(metadata1.digitalPrice, 300);
        assertEq(metadata1.printType, 1);
        
        FGOLibrary.ParentMetadata memory metadata2 = parentContract.getDesignTemplate(parentIds[1]);
    ...
    function testBatchParentUpdate() public {
        ...
        FGOLibrary.UpdateParentParams[] memory updateParams = new FGOLibrary.UpdateParentParams[](2);
        ...
        FGOLibrary.ParentMetadata memory metadata1 = parentContract.getDesignTemplate(parent1Id);
        ...
        FGOLibrary.ParentMetadata memory metadata2 = parentContract.getDesignTemplate(parent2Id);
    ...
    function testChildReferenceValidation() public {
        ...
        FGOLibrary.ChildReference[] memory emptyChildRefs = new FGOLibrary.ChildReference[](0);
    ...
    function testInvalidChildReferenceValidation() public {
        ...
        FGOLibrary.ChildReference[] memory invalidChildRefs = new FGOLibrary.ChildReference[](1);
    ...
    function testBatchSizeConstraints() public {
        ...
        FGOLibrary.CreateParentParams[] memory largeBatch = new FGOLibrary.CreateParentParams[](21);
    ...
    function testInvalidReservedIdCreation() public {
        ...
        vm.expectRevert(FGOErrors.InvalidAmount.selector);
        parentContract.createParent(999, params);
    ...
    function testTokenURI() public {
        ...
        string memory uri = parentContract.tokenURI(parentId);
        assertEq(uri, "ipfs://parent1");
    ...
    function _createSecondParent() private returns (uint256) {
        ...
        steps[0] = FGOLibrary.FulfillmentStep({
            ...
            primaryPerformer: fulfiller1,
            shipToNext: address(0),
            instructions: "Second fulfillment",
            subPerformers: new FGOLibrary.SubPerformer[](0),
            requiredChildIds: new uint256[](0)
        });
