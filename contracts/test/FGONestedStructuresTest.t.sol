...
contract FGONestedStructuresTest is Test {
    ...
    function testCreateChildren() public {
        ...
        uint256 childId3 = child3.createChild(FGOLibrary.CreateChildParams({
            digitalPrice: 0,
    ...
    function testReserveTemplateAutomatic() public {
        ...
        assertTrue(templateMeta.status == FGOLibrary.Status.ACTIVE, "Template should auto-activate");
    ...
    function testReserveParentAutomatic() public {
        ...
        assertTrue(parent.designExists(parentId), "Parent should exist and auto-activate");
        vm.stopPrank();
    }
    ...
    function testNestedParentWithMultipleChildTypes() public {
        ...
        uint256 regularChild1 = child1.createChild(FGOLibrary.CreateChildParams({
            digitalPrice: 1 ether,
            physicalPrice: 2 ether,
            version: 1,
        ...
        uint256 regularChild2 = child2.createChild(FGOLibrary.CreateChildParams({
            digitalPrice: 0.5 ether,
            physicalPrice: 1 ether,
            version: 1,
        ...
        uint256 nestedChild1 = child1.createChild(FGOLibrary.CreateChildParams({
        ...
        uint256 nestedChild2 = child3.createChild(FGOLibrary.CreateChildParams({
        ...
        FGOLibrary.ChildReference[] memory subTemplatePlacements = new FGOLibrary.ChildReference[](2);
        ...
        uint256 additionalChild = child2.createChild(FGOLibrary.CreateChildParams({
        ...
        FGOLibrary.ChildReference[] memory mainTemplatePlacements = new FGOLibrary.ChildReference[](2);
        ...
        FGOLibrary.ChildReference[] memory simpleTemplatePlacements = new FGOLibrary.ChildReference[](2);
        ...
        FGOLibrary.ChildReference[] memory parentChildRefs = new FGOLibrary.ChildReference[](3);
        ...
        assertTrue(parent.designExists(parentId), "Complex nested parent should auto-activate");

        // Verify all templates are active
        FGOLibrary.ChildMetadata memory subTemplateMeta = templateChild.getChildMetadata(subTemplateId);
        FGOLibrary.ChildMetadata memory mainTemplateMeta = templateChild.getChildMetadata(mainTemplateId);
        FGOLibrary.ChildMetadata memory simpleTemplateMeta = templateChild.getChildMetadata(simpleTemplateId);
    ...
    function testMixedAvailabilityNesting() public {
        ...
        uint256 digitalOnlyChild = child1.createChild(FGOLibrary.CreateChildParams({
            digitalPrice: 1 ether,
            physicalPrice: 0,
            version: 1,
        ...
        child2.createChild(FGOLibrary.CreateChildParams({
            digitalPrice: 0,
        ...
        // Create BOTH child
        uint256 bothChild = child3.createChild(FGOLibrary.CreateChildParams({
        ...
        FGOLibrary.ChildReference[] memory mixedPlacements = new FGOLibrary.ChildReference[](2);
        ...
        FGOLibrary.ChildReference[] memory parentChildRefs = new FGOLibrary.ChildReference[](1);
        parentChildRefs[0] = FGOLibrary.ChildReference({
        ...
        assertTrue(parent.designExists(parentId), "Mixed availability parent should work");
        vm.stopPrank();
    }
    ...
    function testEditionLimitValidation() public {
        ...
        uint256 limitedChild = child1.createChild(FGOLibrary.CreateChildParams({
            digitalPrice: 1 ether,
            physicalPrice: 2 ether,
            version: 1,
    ...
    function testLargeAmountsAndEditionLimits() public {
        ...
        uint256 unlimitedChild = child1.createChild(FGOLibrary.CreateChildParams({
        ...
        // Create child with very limited physical editions  
        uint256 limitedChild = child2.createChild(FGOLibrary.CreateChildParams({
        ...
        FGOLibrary.ChildReference[] memory largePlacements = new FGOLibrary.ChildReference[](2);
    ...
    function testManualTemplateReserveApproveCreate() public {
        ...
        child1.approveTemplateRequest(childId, templateId, 2, address(templateChild)); // Approve the amount used in placement

        // Step 3: Create template - should now succeed
        templateChild.createTemplate(templateId);
        
        // Template should now be ACTIVE
        assertTrue(templateChild.isChildActive(templateId), "Template should be active after manual creation");
    ...
    function testManualParentReserveApproveCreate() public {
        ...
        vm.startPrank(supplier1);
        child1.approveParentRequest(childId, parentId, 1, address(parent)); // Approve the amount used in parent
        vm.stopPrank();
    ...
    function testAvailabilityMismatchFailures() public {
        ...
        FGOLibrary.ChildReference[] memory invalidPlacements = new FGOLibrary.ChildReference[](1);
    ...
    function testComplexAvailabilityNesting() public {
        ...
        uint256 bothChild = child2.createChild(FGOLibrary.CreateChildParams({
            digitalPrice: 2 ether,
            physicalPrice: 4 ether,
            version: 1,
            maxPhysicalEditions: 100,
        ...
        assertTrue(templateChild.isChildActive(level1TemplateId), "Level 1 template should be active");
        assertTrue(templateChild.isChildActive(level2TemplateId), "Level 2 template should be active");
    ...
    function testEditionExhaustionScenarios() public {
        ...
        FGOLibrary.ChildReference[] memory template1Placements = new FGOLibrary.ChildReference[](1);
        ...
        FGOLibrary.ChildReference[] memory template2Placements = new FGOLibrary.ChildReference[](1);
