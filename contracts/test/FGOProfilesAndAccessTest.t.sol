...
contract FGOProfilesAndAccessTest is Test {
    ...
    function testSupplierProfile() public {
        ...
        FGOLibrary.SupplierProfile memory metadata = suppliers.getSupplierProfile(profileId);
    ...
    function testDesignerProfile() public {
        ...
        FGOLibrary.DesignerProfile memory metadata = designers.getDesignerProfile(profileId);
        assertEq(metadata.version, 1);
    ...
    function testFulfillerProfile() public {
        ...
        FGOLibrary.FulfillerProfile memory metadata = fulfillers.getFulfillerProfile(profileId);
        assertEq(metadata.version, 1);
