...
contract FGOEmbellishmentsChild is FGOBaseChild {
    ...
    event EmbellishmentsMinted(uint256 indexed childId, address indexed to, uint256 amount);
    ...
    function createChild(
        ...
        uint256 childId = _createChild(
            ...
            minPaymentValue,
            FGOLibrary.ChildType.EMBELLISHMENTS,
            availability,
            isImmutable,
            childUri,
            acceptedCurrencies,
    ...
    function _getChildType() internal pure override returns (FGOLibrary.ChildType) {
        return FGOLibrary.ChildType.EMBELLISHMENTS;
    }
