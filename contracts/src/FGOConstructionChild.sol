...
contract FGOConstructionChild is FGOBaseChild {
    ...
    event ConstructionMinted(uint256 indexed childId, address indexed to, uint256 amount);
    ...
    function createChild(
        ...
        uint256 childId = _createChild(
            ...
            minPaymentValue,
            FGOLibrary.ChildType.CONSTRUCTION,
            availability,
            isImmutable,
            childUri,
            acceptedCurrencies,
    ...
    function _getChildType() internal pure override returns (FGOLibrary.ChildType) {
        return FGOLibrary.ChildType.CONSTRUCTION;
    }
